...
exports.run = async(client, message, args) => {
    ...
    let moderasyonsize = client.commands.filter(cmds => cmds.help.kategori == "mod").map(cmd0 => cmd0.help.kategori == "mod").length;
...
exports.help = {
  ...
  description: 'Botun moderasyon  komutlarını görürsün.',
