...
exports.run = async(client, message, args) => {
    ...
    let moderasyonsize = client.commands.filter(cmds => cmds.help.kategori == "mod").map(cmd0 => cmd0.help.kategori == "ticket").length;
...
${client.commands
  ...
  .filter(c=>c.help.kategori=== "ticket")
...
exports.help = {
  ...
  description: 'Botun ticket  komutlarını görürsün.',
