...
exports.run = async(client, message, args) => {
    ...
    let moderasyonsize = client.commands.filter(cmds => cmds.help.kategori == "skur").map(cmd0 => cmd0.help.kategori == "skur").length;
...
exports.help = {
  ...
  description: 'Sunucu Kur Menüsünü Açar.',
