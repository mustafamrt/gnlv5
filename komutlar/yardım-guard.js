...
exports.run = async(client, message, args) => {
    ...
    let moderasyonsize = client.commands.filter(cmds => cmds.help.kategori == "mod").map(cmd0 => cmd0.help.kategori == "guard").length;
...
${client.commands
  ...
  .filter(c=>c.help.kategori=== "guard")
...
exports.help = {
  ...
  description: 'Botun guard  komutlarını görürsün.',
