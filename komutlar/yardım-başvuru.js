...
exports.run = async(client, message, args) => {
    ...
    let moderasyonsize = client.commands.filter(cmds => cmds.help.kategori == "mod").map(cmd0 => cmd0.help.kategori == "başvuru").length;
...
${client.commands
  ...
  .filter(c=>c.help.kategori=== "başvuru")
...
exports.help = {
  ...
  description: 'Botun başvuru  komutlarını görürsün.',
